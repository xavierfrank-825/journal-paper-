...
class Paper {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " 
                 (title, volume, filename, xml_content, html_content, user_id) 
                 VALUES (:title, :volume, :filename, :xml_content, :html_content, :user_id)";
    ...
    public function readAll() {
        $query = "SELECT p.id, p.title, p.volume, p.filename, p.xml_content, p.html_content, 
